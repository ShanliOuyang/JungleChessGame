...
public class LoadFrame extends JFrame {
    ...
    private String ID;
    public LoadFrame(int width, int height,ChessboardComponent chessboardComponent,String id) {
        setTitle("Save Here");
        this.WIDTH = width;
        this.HEIGTH = height;
    ...
    public void addSaveButtons(){
        {
            ...
            button1.addActionListener(e -> {
                chessboardComponent.getGameController().Load(ID,1);
                setVisible(false);
            });
        }
        {
            ...
            button2.addActionListener(e -> {
                chessboardComponent.getGameController().Load(ID,2);
                setVisible(false);
            });
        }
        {
            ...
            button3.addActionListener(e -> {
                chessboardComponent.getGameController().Load(ID,3);
                setVisible(false);
            });
        }
        {
            ...
            button4.addActionListener(e -> {
                chessboardComponent.getGameController().Load(ID,4);
                setVisible(false);
            });
        }
        {
            ...
            button5.addActionListener(e -> {
                chessboardComponent.getGameController().Load(ID,5);
                setVisible(false);
            });
        }
        {
            ...
            button6.addActionListener(e -> {
                chessboardComponent.getGameController().Load(ID,6);
                setVisible(false);
            });
        }
    }
